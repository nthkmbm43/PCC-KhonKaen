...
export default function FloatingLineBtn() {
  ...
  return (
    <a 
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#06C755] hover:bg-[#05b34c] text-white p-4 rounded-full shadow-[0_8px_30px_rgba(6,199,85,0.4)] flex items-center justify-center transition-all hover:scale-110 group animate-bounce"
